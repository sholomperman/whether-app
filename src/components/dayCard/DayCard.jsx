...
const DayCard = ({ isC, daysData, select, display, setDisplay }) => {
  ...
  const sunny = "url('https://images.unsplash.com/photo-1566134026268-d14204cd72c5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80')"
